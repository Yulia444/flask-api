...
class Event(db.Model):
    ...
    event_type=db.Column(db.Enum('HACKATON', 'GAME', 'WORKSHOP', name='event_type'), default='GAME')
    category_type=db.Column(db.Enum('PYTHON', 'ML', 'PROJECT_MANAGMENT', name='category_type'), default='PYTHON')
